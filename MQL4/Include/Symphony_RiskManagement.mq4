   ...
   public:
      ...
      double position_size(double StopLossLevel, double RiskLevelOrMoneyToRisk)
        ...
        string fours[] = {"EURJPY","GBPJPY","CHFJPY", // symbols with USD as 
         ...
         if(UseEquityInsteadOfBalance) Size = ACCOUNT_EQUITY; else Size = ACCOUNT_BALANCE;
         //---- Risk metrics
      ...
      //                    Basic Account Info
      //---------------------------------------------------
         int lot_size = SYMBOL_VOLUME_MIN;
         switch(lot_size)
                  {
                  ...
                  default:    lotValPerPip=1; Print("[ Symphony | Risk Management ] Uncoded lot size account"); break;
                  }
      ...
      //                    Normalize Lot Size
      //---------------------------------------------------      
             if(lotSize<SYMBOL_VOLUME_MIN) return(SYMBOL_VOLUME_MIN);
