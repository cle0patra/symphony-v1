...
#define     _TITLE_                 "ZigZagZug (v1.3r1) - MetaTrader 4 Indicator"
#define     _ABSTRACT_              "ZigZag Indicator with Extra Features"
#property   copyright               "Copyright © 2014, Fernando M. I. Carreiro"
#property   link                    "mailto:fmi@carreiro.co.pt?subject=ZigZagZug.v1.3"
...
//---- Define ZigZag Parameters
     int
        intDepth            = 20        // Depth Search of ZigZag Extreems
...
//---- Initialise Buffer Index and other Properties
    int init()
    {
        ...
        if( boolShowBreakOut || boolAlertOnBreakOut )  // Extra Indicator Buffers
        {
            // Set Buffer Index
